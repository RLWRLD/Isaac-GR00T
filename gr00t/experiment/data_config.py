...
###########################################################################################
class FrankaHookDataConfig(BaseDataConfig):
    video_keys = ["video.camera_ego", "video.camera_ext"]
    state_keys = ["state.arm_joints"]
    action_keys = ["action.arm_joints"]
    language_keys = ["annotation.human.task_description"]
    observation_indices = [0]
    action_indices = list(range(16))
...
class AlohaPutCubeDataConfig(BaseDataConfig):
    video_keys = ["video.camera_high", "video.camera_right_wrist"]
    state_keys = ["state.arm_joints"]
    action_keys = ["action.arm_joints"]
    language_keys = ["annotation.human.task_description"]
    observation_indices = [0]
...
class MimicgenBoxCleanupDataConfig(BaseDataConfig):
    video_keys = ["video.camera_ego", "video.camera_ext"]
    state_keys = ["state.arm_joint1", "state.hand_joint1", "state.arm_joint2", "state.hand_joint2"]
    action_keys = ["action.arm_joint1", "action.hand_joint1", "action.arm_joint2", "action.hand_joint2"]
    language_keys = ["annotation.human.task_description"]
    observation_indices = [0]
    action_indices = list(range(16))
...
class Gr1CubeDataConfig(BaseDataConfig):
    video_keys = ["video.camera_ego", "video.camera_ext"]
    state_keys = [
        "state.torso_joints",
        "state.head_joints",
...
class AllexCubeDataConfig(BaseDataConfig):
    video_keys = ["video.camera_ego", "video.camera_ext"]
    state_keys = [
        "state.torso_joints",
        "state.head_joints",
...
DATA_CONFIG_MAP = {
    ...
    "franka_hook": FrankaHookDataConfig(),
