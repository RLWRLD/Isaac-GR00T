#!/bin/bash
#SBATCH --job-name=cotrain_agibot_beta_gr1
#SBATCH --nodes=1
#SBATCH --gpus=8
#SBATCH --partition=h100
#SBATCH --output=out/test_%j.out    # %j는 JobID
#SBATCH --error=out/test_%j.err
#SBATCH --comment="cotrain AgiBotWorld-Beta lerobot v2 gr1 dataset"
...
python /virtual_lab/rlwrld/heeseung/Isaac-GR00T_new/scripts/gr00t_cotrain.py \
  ...
  --output-dir /rlwrld/heeseung/checkpoints/gr00t_cotrain_agibot_beta_gr1_v1 \
  --data-config agibot_beta1 --embodiment_tag new_embodiment --video_backend torchvision_av \
  --dataloader-num-workers 8 --max-steps 120000 --save-steps 20000 --random_diffusion --resume